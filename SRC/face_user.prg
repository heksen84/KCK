*-----------------------------------------------------------
* Процедура выдает информацию о оплате абонента в отчете
*-----------------------------------------------------------
PROCEDURE face_user
...
FOR i = 1 TO 12
	...
	REPLACE schet_681	WITH alias_t.коррекция + alias_t._441 + alias_t._451 + alias_t._334
	REPLACE saldo		WITH alias_t.сальдо
	ENDIF
ENDFOR
